...
const ProductInfoPage: FC = () => {
  ...
  const handlePaymentInitiation = async () => {
    try {
      ...
      // Check if the response contains data and authorization_url
      if (response && 'data' in response && 'authorization_url' in response.data.data) {
        const paymentResponse = response as InitiatePaymentResponse;
