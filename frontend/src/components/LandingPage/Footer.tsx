...
import { FooterContact, FooterContainer, FooterInnerContainer,
FooterInfo, FooterLinks, FooterLogo, FooterDescription,
ContactItem, LinksGroup, FooterBottom, FooterBottomLinks, FooterBottomText
